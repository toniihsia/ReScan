...
export function findKeywords(parsedInfo,divId) {
  ...
  Algorithmia.client("simCnX5SgvLeu7IMGCGgT0GWnE41")
       ...
       .then(function(output) {
         ...
         console.log(window.jobKeywords && window.resumeKeywords);
...
function suggestedKeywords(resumeKeywords, jdKeywords) {
  console.log("in suggestedKeywords");
  ...
  document.getElementById('suggestion-1').innerHTML = `${keywordSuggestions[0][0]}, ${keywordSuggestions[0][1]}, ${keywordSuggestions[0][2]}`;
  document.getElementById('suggestion-2').innerHTML = `${keywordSuggestions[1][0]}, ${keywordSuggestions[1][1]}, ${keywordSuggestions[1][2]}`;
  document.getElementById('suggestion-3').innerHTML = `${keywordSuggestions[2][0]}, ${keywordSuggestions[2][1]}, ${keywordSuggestions[2][2]}`;
}
