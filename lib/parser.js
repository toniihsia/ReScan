...
export function formatForKeywords(resume, jobDesc){
  return [[resume,jobDesc], 3];
}

//Format [["leadership",""], 3]
export function formatForKeywordsStripped(resume, jobDesc){
  return [[parseToKeywords(resume),parseToKeywords(jobDesc)], 3];
}
